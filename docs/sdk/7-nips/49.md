...
```swift,ignore
{{#include ../../../snippets/swift/Sources/nip49.swift:parse-secret-key}}
```
...
```swift,ignore
{{#include ../../../snippets/swift/Sources/nip49.swift:encrypt-default}}
```
...
```swift,ignore
{{#include ../../../snippets/swift/Sources/nip49.swift:encrypt-custom}}
```
...
```swift,ignore
{{#include ../../../snippets/swift/Sources/nip49.swift:parse-ncryptsec}}
```
...
```swift,ignore
{{#include ../../../snippets/swift/Sources/nip49.swift:decrypt}}
```
...
```swift,ignore
{{#include ../../../snippets/swift/Sources/nip49.swift:full}}
```
